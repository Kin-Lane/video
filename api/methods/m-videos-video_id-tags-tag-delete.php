<?php
$route = '/videos/:video_id/tags/:tag';
$app->delete($route, function ($video_id,$tag)  use ($app){
	...
	if(isset($tag))
		...
		if($ChecktagResults && mysql_num_rows($ChecktagResults))
			...
			$DeleteQuery = "DELETE FROM video_tag_pivot WHERE tag_id = " . trim($tag_id) . " AND video_id = " . trim($video_id);
